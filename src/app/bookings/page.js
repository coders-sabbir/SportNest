...
import { 
  ...
  Clock3, ArrowRight, Eye, Trash2, Loader2
} from "lucide-react";
...
export default function MyBookingsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0F172A] pt-32 pb-24 overflow-hidden relative font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
          ...
          <div className="bg-[#111827]/60 backdrop-blur-xl border border-[#A3FF12]/20 p-6 rounded-2xl flex flex-col shadow-[0_0_20px_rgba(163,255,18,0.05)] relative overflow-hidden">
            ...
            <p className="text-sm text-[#A3FF12]/80 font-medium">Active Reservations</p>
          </div>
        ...
        <div className="sticky top-24 z-40 bg-[#111827]/80 backdrop-blur-2xl border border-white/10 rounded-2xl p-4 mb-8 shadow-[0_20px_40px_-10px_rgba(0,0,0,0.5)] flex flex-col lg:flex-row gap-4 items-center justify-between">
